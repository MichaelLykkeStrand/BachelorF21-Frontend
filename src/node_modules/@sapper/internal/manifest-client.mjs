...
export const ignore = [/^\/course\/courseList\/?$/, /^\/auth\/login\/?$/, /^\/auth\/token\/?$/];
...
if (typeof window !== 'undefined') {
	import("C:/Users/JLH/Documents/PederVS/BachelorF21-Frontend/node_modules/sapper/sapper-dev-client.js").then(client => {
